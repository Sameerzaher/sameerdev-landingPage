export function UrgencySection() {
  return (
    <section
      className="scroll-mt-24 border-b border-white/5 bg-white/[0.02] px-4 py-6 sm:px-6 sm:py-8"
      aria-labelledby="urgency-heading"
    >
      <div className="mx-auto max-w-3xl">
        <div className="rounded-2xl border border-accent/25 bg-gradient-to-br from-accent/[0.09] via-surface/40 to-surface/30 px-4 py-4 shadow-card ring-1 ring-accent/10 sm:px-6 sm:py-5">
          ...
          <p className="mt-4 text-center text-sm leading-relaxed text-muted">
            ...
            אפשר לשאול בוואטסאפ מה פנוי השבוע. בלי התחייבות רק בשליחת הודעה.
          </p>
        </div>
      </div>
    </section>
